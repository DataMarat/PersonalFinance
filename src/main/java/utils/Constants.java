...
public class Constants {
    ...
    public static final String REGISTER_USER_COMMAND = "Register User";
    public static final String LOGIN_COMMAND = "Login";
    public static final String LOGOUT_COMMAND = "Logout";
    public static final String CREATE_WALLET_COMMAND = "Create Wallet";
    public static final String ENTER_WALLET_COMMAND = "Enter Wallet";
    public static final String VIEW_CATEGORIES_COMMAND = "View Categories";
